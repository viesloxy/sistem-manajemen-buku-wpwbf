    ...
    <style>
        ...
        *::after {
        ...
        @keyframes goldPulse {
            ...
            100% {
                transform: scale(1);
                text-shadow: 0 0 40px rgba(251, 191, 36, .45);
            }

            50% {
                transform: scale(1.04);
                text-shadow: 0 0 60px rgba(251, 191, 36, .6);
            }
        }
        ...
        .stat-card.cyan .stat-angka {
            color: #00d2ff;
        }

        .stat-card.yellow .stat-angka {
            color: var(--pa-gold);
        }

        .stat-card.green .stat-angka {
            color: var(--pa-green);
        }

        .stat-card.purple .stat-angka {
            color: var(--pa-purple2);
        }
    ...
    <script>
        ...
        source.addEventListener('queue-update', function (event) {
            ...
            if (data.dipanggil) {
                ...
                console.log('Nomor dipanggil:', data.dipanggil.nomor, 'ID:', idSekarang, 'Last ID:', lastDipanggilId);

                if (idSekarang !== lastDipanggilId) {
                    console.log('NOMOR BARU DIPANGGIL! Memutar audio...');
                    ...
                    console.log('Nomor sama, tidak memutar audio');
                }
            }
